                ...
                for output in res.outputs:
                    ...
                    # when only reasoning
                        ...
                        if prompt_is_reasoning_end_arr[i]:
                            ...
                            # Reasoning-end detection: parser may signal end
                            # via is_reasoning_end on the cumulative token
                            # stream even when extract_reasoning_streaming
                            # returns no content delta.
                            if (
                            ...
                            # Once reasoning has ended, promote any further
                            # reasoning-only delta to content so OpenAI
                            # clients don't receive null content.
                            if (
                                reasoning_end_arr[i]
                                and delta_message
